...
class TestPackageConan(ConanFile):
    ...
    def requirements(self):
        boost_deps = ['asio', 'assert', 'beast', 'bind', 'config', 'container', 'core', 'endian', 'intrusive', 'optional', 'smart_ptr', 'static_assert', 'system', 'throw_exception', 'type_traits', 'utility', 'winapi']
